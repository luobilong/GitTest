...
// 搜索产品接口 参数 keyword  currentPage pageSize
#define kSearchProductUrl @"http://123.57.155.106:8080/labonline/ejtController/searchCpList.do"
// 系统升级
...
// e检通产品分类接口
#define kEJTCateUrl @"http://123.57.155.106:8080/labonline/ejtController/queryCpflList.do?versionCode=0"
// e检通产品列表接口 参数 classifyid
#define kEJTProductListUrl @"http://123.57.155.106:8080/labonline/ejtController/queryCpList.do"
// e检通增加阅读数
#define kAddProductReadCountsUrl @"http://123.57.155.106:8080/labonline/ejtController/updateLll.do?productid=%@"
